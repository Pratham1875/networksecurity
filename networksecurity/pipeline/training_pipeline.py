...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            data__ingestion_artifact=data_ingestion.initiate_data_ingestion()
            logging.info(f"Data ingestion Completed and Artifact:{data__ingestion_artifact}")
            return data__ingestion_artifact
